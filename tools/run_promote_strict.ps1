...
& (Join-Path $PSScriptRoot 'promote_policy.ps1') -CandidatePath $cand.FullName -SimulationReport (Join-Path $PSScriptRoot 'runs\positive_sim.json') -DryRun -StrictParsing -Verbose
